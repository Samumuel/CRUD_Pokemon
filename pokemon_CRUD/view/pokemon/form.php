            ...
            <form method="POST" action="" border="1" class="p-3 rounded-4 border border-5 border-primary bg-light">
                ...
                <div class="mb-3 border-primary">
                    <input type="number" id="numEvolucao" name="evolucao"
                        placeholder="Informe a evolução" class="form-control " max="3" min="1"
                        value="<?= $pokemon ? $pokemon->getEvolucao() : '' ?>">
                </div>

                <div class="mb-3 border-primary">
                    <input type="number" id="numGeracao" name="geracao"
                        placeholder="Informe a geração" class="form-control " max="9" min="1"
                        value="<?= $pokemon ? $pokemon->getGeracao()->getNumero() : '' ?>">
                </div>
