...
require_once(__DIR__ . "/Habilidade.php");
...
class Pokemon {
	 ...
	 */
	public function setHabilidade(?Habilidade $habilidade): self
	{
	...
	public function getGeraCard()
    {
		...
		echo "Habilidades de: " . $this->getHabilidade()->getTipo() . "<br>";
		echo "Tem vantagem sobre: " . $this->getHabilidade()->getVantagem() . "<br>";
		echo "Tem desvantagem sobre: " . $this->getHabilidade()->getDesvantagem() . "<br>";
