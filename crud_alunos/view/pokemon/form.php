...
<h3><?= $pokemon && $pokemon->getId() > 0 ? 'Alterar' : 'Inserir' ?> 
        pokemon</h3>
        ...
        <form method="POST" action="">
            ...
            <div>
                ...
                <input type="number" id="txtIdade" name="idade"
                    ...
                    value="<?= $pokemon ? $pokemon->getIdade() : '' ?>">
            </div>
            ...
            <div>
                ...
                <select name="estrang" id="selEstrang" class="form-select">
                    ...
                    <option value="S"
                    <?= $pokemon && $pokemon->getEstrangeiro() == 'S' ? 'selected' : '' ?> 
                    >Sim</option>
                    <option value="N"
                        <?= $pokemon && $pokemon->getEstrangeiro() == 'N' ? 'selected' : '' ?>
                    >Não</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="curso" id="selCurso" class="form-select">
                    ...
                    <?php foreach($cursos as $c): ?>
                        ...
                        <?php
                            if($pokemon && $pokemon->getCurso() && 
                                $pokemon->getCurso()->getId() == $c->getId())
                                echo "selected"; 
                        ?>
